    ...
    <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        @if(Auth::user()->role == 'super admin')
            <li>
                <a href="{{route('user.index')}}">
                    <div class="pull-left"><i class="fa fa-users mr-20"></i><span class="right-nav-text">User </span>
                    </div>
                    <div class="clearfix"></div>
                </a>
            </li>
        ...
        <li>
            <a href="{{route('product.index')}}">
                <div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Product </span>
                </div>
                <div class="clearfix"></div>
            </a>
        </li>
        <li>
            <a href="{{route('transaction.index')}}">
                <div class="pull-left"><i class="zmdi zmdi-money-box mr-20"></i><span
                            class="right-nav-text">Transaction </span>
                </div>
                <div class="clearfix"></div>
            </a>
        </li>
        ...
        {{--</li>--}}
        {{--<li>--}}
        {{--<a href="javascript:void(0);" data-toggle="collapse" data-target="#ecom_dr"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">E-Commerce</span></div></a>--}}
        ...
        {{--</li>--}}
        {{--<li>--}}
        {{--<a class="active-page" href="javascript:void(0);" data-toggle="collapse" data-target="#invoice_dr">Invoice<div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>--}}
        {{--<ul id="invoice_dr" class="collapse collapse-level-2">--}}
        {{--<li>--}}
        {{--<a class="active-page" href="invoice.html">Invoice</a>--}}
        {{--</li>--}}
        {{--<li>--}}
