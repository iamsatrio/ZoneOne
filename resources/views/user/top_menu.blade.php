<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div id="mobile_only_nav" class="mobile-only-nav pull-right">
        <ul class="nav navbar-right top-nav pull-right">
            <li>
                <a href="{{route('products')}}"><i class="zmdi zmdi-apps top-nav-icon"></i></a>
            </li>
            <!-- Settings-->
            {{--<li>--}}
                        ...
                        {{--<ul class="pa-20">--}}
                            ...
                            {{--<li class="col-md-6 col-xs-12 preview-carousel">--}}
                                ...
                                {{--<div class="product-carousel owl-carousel owl-theme text-center">--}}
                                    {{--<a href="#">--}}
                                        {{--<img src="{{asset('philbert/dist/img/chair.jpg')}}" alt="chair">--}}
                                        {{--<span>Circle chair</span>--}}
                                    {{--</a>--}}
                                    {{--<a href="#">--}}
                                        {{--<img src="{{asset('philbert/dist/img/chair2.jpg')}}" alt="chair">--}}
                                        {{--<span>square chair</span>--}}
                                    {{--</a>--}}
                                    {{--<a href="#">--}}
                                        {{--<img src="{{asset('philbert/dist/img/chair3.jpg')}}" alt="chair">--}}
                                        {{--<span>semi circle chair</span>--}}
                                    {{--</a>--}}
                                    {{--<a href="#">--}}
                                        {{--<img src="{{asset('philbert/dist/img/chair4.jpg')}}" alt="chair">--}}
                    ...
                    {{--<li>--}}
                        {{--<div class="streamline message-nicescroll-bar">--}}
                            ...
                            {{--<div class="sl-item">--}}
                                {{--<a href="javascript:void(0)">--}}
                                    {{--<div class="sl-avatar">--}}
                                        {{--<img class="img-responsive" src="{{asset('philbert/dist/img/avatar.jpg')}}" alt="avatar"/>--}}
                                    {{--</div>--}}
                                    {{--<div class="sl-content">--}}
