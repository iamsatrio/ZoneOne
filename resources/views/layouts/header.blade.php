            ...
            <div class="row">
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        <div class="logo"><a href="{{ route('products') }}">Zone One</a></div>
                        <nav class="main_nav">
                            <ul>
                                <li><a href="{{route('productCategory.index')}}">All</a></li>
                                @foreach($categories as $category)
                                    <li>
                                        <a href="{{route('productCategory.show',$category->id)}}">{{$category->name}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </nav>
